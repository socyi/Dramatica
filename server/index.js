...
app.get('/api/getPlays', (req, res) => {
    const sql = "SELECT WorkID,Title FROM works ORDER BY Title Asc"; 
...
app.post('/api/upload', (req,res) =>{
    ...
    const filename=Date.now()+""+req.files.text.name;
